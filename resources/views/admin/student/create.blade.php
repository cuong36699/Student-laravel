...
{!! Form::open(array('url' => 'admin/student', 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '')) !!}
<div class="form-horizontal">
	...
	<div class=" container">
		...
		<div class="col-md-6 khung">	
			...
			{{-- ngoại trú --}}
			<div class="col-md-6 khung">
				@include('admin.student.member.create')
			</div>
			{{-- thường trú --}}
			<div class="col-md-6 khung">
				@include('admin.student.risident.create')
			</div> 
		</div>
		{{-- button --}}
